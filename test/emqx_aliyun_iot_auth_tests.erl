...
-import(emqx_aliyun_iot_auth, [gen_password/5]).
-import(emqx_plugin_aliyun_iot_auth, [on_client_authenticate/3]).



gen_password_test() ->
  Result = emqx_aliyun_iot_auth:gen_password("11111", "test1", "aa", "2524608000000", "bb"),
